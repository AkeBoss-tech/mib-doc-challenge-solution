#!/usr/bin/env python3
"""Train and export the conservatively gated visible-OCR approval model."""
...
def main() -> None:
    ...
    labels = [truth[case_id]["adjudication"] == "APPROVED" for case_id in ids]
    ...
    classifier = LogisticRegression(
        C=8.0, class_weight="balanced", max_iter=1000,
    ...
    payload = {
        "schema": "akeboss-visible-ocr-approval/v1",
